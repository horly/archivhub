...
return [
    ...
    */
    ...
    'enter_your_email_&_password_to_login' => "Saisissez votre adresse e-mail et votre mot de passe pour vous connecter",
    'change_language' => "Changer de langue",

    'select_the_role' => "Sélectionner le rôle",
    'please_select_the_role' => "Veuillez sélectionner le rôle",

    'superadmin' => "Super administrateur",
    'admin' => "Administrateur",
    'user' => "Utilisateur",

    'please_enter_a_valid_full_name' => "Veuillez saisir un nom complet valide",
    'registration_successfully_completed' => "Enregistrement effectué avec succès",
    'log_out' => "Déconnexion",

    'add_user' => "Ajouter un utilisateur",
    'enter_the_users_full_name' => "Entrez le nom complet de l'utilisateur",
    'enter_the_users_email_address' => "Entrez l'adresse e-mail de l'utilisateur",

    'please_enter_the_users_full_name' => "Veuillez saisir le nom complet de l'utilisateur",
    'please_enter_the_users_email_address' => "Veuillez saisir l'adresse e-mail de l'utilisateur",
    'please_enter_the_users_password' => "Veuillez saisir le mot de passe de l'utilisateur",
    'please_confirm_password' => "Veuillez confirmer le mot de passe",

    'has_added_a_new_user' => "a ajouté un nouvel utilisateur",
    'has_updated_user' => "a modifié un utilisateur",

    'update_user' => "Modifier un utilisateur",
    'has_deleted_a_user' => "a supprimé un utilisateur",
    'my_profile' => "Mon profil",
    'updated_his_profile_information' => "a mis à jour ses informations de profil",
];
