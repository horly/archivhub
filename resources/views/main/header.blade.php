...
<header class="page-header row">
    <div class="logo-wrapper d-flex align-items-center col-auto">
        <a href="{{ route('app_site') }}"><img class="light-logo img-fluid" src="{{ asset('assets/images/logo/LOGO-ARCHIVHUB-CUT-WH.png') }}" width="100" alt="logo"/><img class="dark-logo img-fluid" src="{{ asset('assets/images/logo/LOGO-ARCHIVHUB-CUT.png') }}" width="100" alt="logo"/></a>
                ...
                <div class="custom-menu overflow-hidden">
                    <ul class="profile-body">
                        <li class="d-flex">
                            ...
                            <a class="ms-2" href="{{ route('app_site') }}">{{ __('dashboard.home') }}</a>
                        </li>
                        <li class="d-flex">
                            <span class="icon-profile">
