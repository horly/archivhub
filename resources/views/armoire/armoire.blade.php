                        ...
                        <div class="row input-group-wrapper">
                            <div class="col-md-3">
                                <div class="input-group mb-3">
                                    ...
                                    <a class="btn btn-outline-secondary" href="{{ route('app_armoire', ['id_site' => $site->id, 'id_room' => $room->id]) }}">
                            ...
                            @foreach ($armoires as $armoire)
                                <div class="col-lg-3 col-md-6 mb-4">
                                    <div class="city-card border">
                                        ...
                                        <div class="mb-3">
                                            @php
                                                $etageres = App\Models\Etagere::where('id_armoire', $armoire->id)->get();
                                            @endphp
                                            <div>
                                                <i class="fa-solid fa-layer-group stat-icon" style="width: 25px"></i>
                                                <span>{{ number_format($etageres->count(), 0, '', ' ') }} {{ __('dashboard.shelves') }}</span>
                                            </div>
                                            <div>
